...
export default function Profile() {
  ...
  const recentPosts = [
    { id: 1, title: "Building Modern React Applications", date: "2024-01-15", status: "Published" },
    { id: 2, title: "The Art of Minimalist Design", date: "2024-01-12", status: "Published" },
    { id: 3, title: "Typography in Web Design", date: "2024-01-10", status: "Published" },
  ];
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="mt-6">
              ...
              <button
                onClick={signOut}
                className="w-full bg-red-500 text-white py-2 px-4 rounded-md hover:bg-red-600 transition-colors mt-2.5"
              >
                Sign Out
              </button>
            </div>
